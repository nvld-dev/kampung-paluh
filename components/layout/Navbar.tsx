...
export default function Navbar() {
  ...
  const handleSearch = (
    ...
    router.push(
      `/cari?q=${encodeURIComponent(query)}`
    );
  };
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            <input
              ...
              aria-label="Cari di Kampung Paluh"
              tabIndex={searchOpen ? 0 : -1}
              className={`absolute right-[calc(100%+8px)] h-10 rounded-full border border-[#dce3df] bg-white px-4 text-[13px] text-[#173d31] outline-none transition-all duration-300 placeholder:text-[#9aa39f] focus:border-[#075b43] dark:border-[#293a32] dark:bg-[#16231d] dark:text-[#edf5f0] dark:placeholder:text-[#71817a] ${
                searchOpen
