export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          className="
            absolute inset-0 scale-105 bg-cover bg-center
        ...
        <div className="max-w-[720px]">
          ...
          <div
            className="
              ...
              rounded-full
              border border-[#075b43]/10
              bg-white/75
              px-4 py-2.5
              shadow-sm
              backdrop-blur-md
              transition-colors duration-500
              dark:border-[#75c6a4]/15
              dark:bg-[#10221b]/75
            "
          >
            <span
          ...
          <p
            ...
            "
          >
            Temukan profil kampung, potensi lokal, produk UMKM,
            kegiatan masyarakat, serta cerita yang tumbuh di
            Kampung Paluh.
          </p>
  ...
  className="
    ...
    font-semibold
    text-white
    shadow-[0_10px_30px_rgba(0,60,43,0.15)]
    transition-all duration-300
    hover:-translate-y-0.5
    hover:bg-[#075b43]
    hover:shadow-[0_14px_35px_rgba(0,60,43,0.2)]
    dark:bg-[#075b43]
    dark:text-white
      ...
      />
            ...
            <a
              ...
              className="
                ...
                dark:bg-[#10221b]/70
                dark:text-[#a8cfc0]
                dark:hover:border-[#75c6a4]/20
                dark:hover:bg-[#17352a]
                dark:hover:text-[#c3ead5]
              "
            >
              Tentang Kampung
            </a>
      ...
      >
        ...
        <div
          className="
            ...
            rounded-full
            border border-[#31594b]/30
            p-1
            transition-colors duration-500
            dark:border-[#9de0bf]/25
          "
        >
          <span
            className="
